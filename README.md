# Порождающие шаблоны. Singleton. Логгер

Практика с шаблоном *Singleton* (*Одиночка*). Написана программа, которая будет каждый свой шаг обильно логгировать в консоль, но не напрямую через `System.out.println`, а через объект-логгер нашего собственного класса-синглтона.
...
4. Программа создаёт объект `filter` нашего класса `Filter`, передав в конструктор значение `f`
